                        ...
                        <form id={LoginStyle.login_from} name="fsearchbox" onSubmit={onSubmit}>
                            <div className={LoginStyle.form_cont}>
                                <div className={`${LoginStyle.from_wrap} ${LoginStyle.user_id}`}>
                                    ...
                                    <div class={LoginStyle.input_box}>
                                        <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg" class={LoginStyle.input_icon}>
                                            <mask id="path-1-outside-1_8_2" maskUnits="userSpaceOnUse" x="-0.75" y="-0.25" width="19" height="14" fill="black">
                                        ...
                                        {/* <input id="userId" type="text" placeholder="이메일을 입력해주세요." name="stx1" value={email} onChange={(e) => setEamil(e.target.value)} required /> */}
                                        <input id="userId" type="text" placeholder="이메일을 입력해주세요." name="stx1" value={email} onChange={handleEmailInputChange} className={isValidEmail ? "" : `${LoginStyle.input_error}`} required />
                                        <div className={`${LoginStyle.error_wrap} ${LoginStyle.error_wrap1} ${isValidEmail ? "" : LoginStyle.on}`}>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="error_icon1" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                                <path d="M10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20Z" fill="#F03738"></path>
                                                <path
                                                    fill-rule="evenodd"
                                                    clip-rule="evenodd"
                                            ...
                                            <p className={`${LoginStyle.error_txt} hide1 ${isHover ? "" : `${LoginStyle.in}`}`}>이메일 형식을 확인해주세요.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className={`${LoginStyle.from_wrap} ${LoginStyle.user_password}`}>
                                    ...
                                    <div className={LoginStyle.input_box}>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class={LoginStyle.input_icon}>
                                            <path
                                            ...
                                            ></path>
                                            <path d="M14.1654 6.66667C14.6256 6.66667 14.9987 6.29357 14.9987 5.83333C14.9987 5.3731 14.6256 5 14.1654 5C13.7051 5 13.332 5.3731 13.332 5.83333C13.332 6.29357 13.7051 6.66667 14.1654 6.66667Z" stroke="#74797D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <input id="userPassword" type="password" placeholder="영문 대소문자,숫자,특수문자 중 2종류 조합의 8-15자" name="stx2" value={password} onChange={(e) => setPassword(e.target.value)} required />
                                        <div className={`${LoginStyle.error_wrap} ${LoginStyle.error_wrap2}`}>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="error_icon2">
                                                <path d="M10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20Z" fill="#F03738"></path>
                                                <path
                                                    fill-rule="evenodd"
                                                    clip-rule="evenodd"
                                            ...
                                            <p className={`${LoginStyle.error_txt} hide2`}>비밀번호를 입력해주세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
