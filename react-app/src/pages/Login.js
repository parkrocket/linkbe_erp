                            ...
                            <div className={LoginStyle.form_cont}>
                                <div className={`${LoginStyle.from_wrap} ${LoginStyle.user_id}`}>
                                    ...
                                    <div className={LoginStyle.input_box}>
                                        ...
                                        <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg" className={LoginStyle.input_icon}>
                                        ...
                                        <input id="userId" type="text" placeholder="이메일을 입력해주세요." name="stx1" value={email} onChange={handleEmailInputChange} className={isValidEmail ? "" : `${LoginStyle.input_error}`} required ref={emailInputRef} />
                                        <div className={`${LoginStyle.error_wrap} ${LoginStyle.error_wrap1} ${isValidEmail ? "" : LoginStyle.on}`}>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" onMouseEnter={handleErrorMouseEnter1} onMouseLeave={handleErrorMouseLeave1}>
                                            ...
                                            <p className={`${LoginStyle.error_txt} hide1 ${isErrorHover1 ? "" : `${LoginStyle.in}`}`}>이메일 형식을 확인해주세요.</p>
                                ...
                                <div className={`${LoginStyle.from_wrap} ${LoginStyle.user_password}`}>
                                    ...
                                    <div className={LoginStyle.input_box}>
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={LoginStyle.input_icon}>
                                            ...
                                            ></path>
                                            <path d="M14.1654 6.66667C14.6256 6.66667 14.9987 6.29357 14.9987 5.83333C14.9987 5.3731 14.6256 5 14.1654 5C13.7051 5 13.332 5.3731 13.332 5.83333C13.332 6.29357 13.7051 6.66667 14.1654 6.66667Z" stroke="#74797D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                        </svg>
                                        <input id="userPassword" type="password" placeholder="영문 대소문자,숫자,특수문자 중 2종류 조합의 8-15자" name="stx2" value={password} onChange={handlePasswordInputChange} className={isValidPassword ? "" : `${LoginStyle.input_error}`} required ref={passwordInputRef} />
                                        <div className={`${LoginStyle.error_wrap} ${LoginStyle.error_wrap2} ${isValidPassword ? "" : LoginStyle.on}`}>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" onMouseEnter={handleErrorMouseEnter2} onMouseLeave={handleErrorMouseLeave2}>
                                                <path d="M10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20Z" fill="#F03738"></path>
                                            ...
                                            <p className={`${LoginStyle.error_txt} hide2 ${isErrorHover2 ? `${LoginStyle.in}` : ""}`}>비밀번호를 확인해주세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
