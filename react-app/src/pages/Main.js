                    ...
                    <div className={MainStyle.wrapper}>
                        {user.isAuthenticated ? (
                            <div>
                                ...
                                <Button onClick={() => handleClick("출근하자")} className="bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 p-20 margin-c display-b">
